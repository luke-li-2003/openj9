...
hashCodeHelper(TR::Node *node, TR::CodeGenerator *cg, TR::DataType elementType,
   ...
   // we need an extra register for handling an initial value
   TR::Register *temp2Reg = nonZeroInitial ? cg->allocateRegister() : NULL;
   ...
   TR::LabelSymbol *AlignedPrepLabel = nonZeroInitial ? generateLabelSymbol(cg) : NULL;
   ...
   static uint32_t multiplierVectors_be16[12] = {0x94446F01, 0x94446F01, 0x94446F01, 0x94446F01,
      0x67E12CDF, 887503681, 28629151, 923521, 29791, 961, 31, 1};
   ...
   if (elementType == TR::Int32) // we don't need to unpack 32 bit values
      {
   ...
   TR::RegisterDependencyConditions *dependencies =
      new (cg->trHeapMemory()) TR::RegisterDependencyConditions(0,
         ...
         + (nonZeroInitial ? 1 : 0), // temp2Reg needed for nonZeroInitial
         cg->trMemory());
